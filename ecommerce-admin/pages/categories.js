...
function Categories({swal}) {
    ...
    function fetchCategories() { //функция извлечения категорий
      setIsLoading(true);
    ...
    return (
        <Layout>
            ...
            <label>{editedCategory ? `Редактирование категории ${editedCategory.name}` : 'Создание новой категории'}</label>
          <form onSubmit={saveCategory}> 
          <div className=" flex gp-1">
            <input
              type="text" 
                ...
                <tr>
                  ...
                  <td>
                    <button 
                      ...
                      className="btn-primary mr-1 my-1"
                    >Править
                    </button>
                    <button 
