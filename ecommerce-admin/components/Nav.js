...
export default function Nav({show}) {
  ...
  const activeLink = inactiveLink+' bg-white text-primary rounded-lg mr-4';
  ...
  return (
    <aside className={(show?'left-0 ':' -left-full')+" top-0 text-white p-4 pr-0 fixed w-full bg-primary h-full md:static md:w-auto transition-all"}>
